...
public class MatrixUtils {
    ...
    public Matrix4f createTransformationMatrix(Transform transform) {
        ...
        transformationMatrix = transformationMatrix.multiply(Matrix4f.translate(transform.getPos().x, transform.getPos().y, transform.getPos().z));
        transformationMatrix = transformationMatrix.multiply(Matrix4f.rotate(transform.getRot().x, 1, 0, 0));
        transformationMatrix = transformationMatrix.multiply(Matrix4f.rotate(transform.getRot().y, 0, 1, 0));
        transformationMatrix = transformationMatrix.multiply(Matrix4f.rotate(transform.getRot().z, 0, 0, 1));
